          ...
          <div class="alert" slot="footer">
            <div class="row">
              ...
              <div class="col-sm-6" align="center">
                ...
                <a class="btn btn-sm btn-warning btn-icon display-inline" @click="sendAlertToDoctor(alertControl._id, alertControl.alert._id,  alertControl.alert.user._id)">
                  <!-- <i class="ti-check"></i>  -->
                  Mandar a su doctor
                </a>
...
<script>
  ...
  export default {
    ...
    created: function () {
      ...
      AlertService.getAlertControls().then((response) => {
    ...
    methods: {
      ...
      sendAlertToDoctor: function (alertControlId, alertId, patientId) {
        AlertService.sendAlertToDoctor(alertControlId, alertId, patientId).then((res) => {
          this.alertControls = this.alertControls.filter(ac => ac._id !== alertControlId);
        });
      },
